...
- Payment is entirely optional — the core plugin is fully functional without it.
- Filters: `nvoos_content_graph/payments/vendor_api_url`, `nvoos_content_graph/payments/price_cents`, `nvoos_content_graph/payments/addon_version`, `nvoos_content_graph/payments/addon_zip_url`, `nvoos_content_graph/payments/fallback_url`, `nvoos_content_graph/payments/terms_url`, `nvoos_content_graph/payments/refund_policy_url`
- Reviewer-facing notes for the wp.org plugin team: [`WPORG-REVIEW-COMMERCE-NOTES.md`](WPORG-REVIEW-COMMERCE-NOTES.md)
...
- [`docs/commerce-vendor-api.md`](docs/commerce-vendor-api.md) — vendor checkout API contract
